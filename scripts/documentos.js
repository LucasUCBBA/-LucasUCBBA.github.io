...
datab.collection("documento").onSnapshot((querySnapshot) => {
    tabladoc.innerHTML = '',
    querySnapshot.forEach((doc) => {
        ...
        <tr>
            ...
            <td><button class="mdl-button mdl-js-button mdl-button--raised mdl-color--yellow-500" onclick="editardoc('${doc.id}','${doc.data().numDoc}','${doc.data().tipoDoc}','${doc.data().fecha}','${doc.data().estadoDoc}','${doc.data().idOwner}')">Editar</button></td>
...
function editardoc(id,numDoc,tipoDoc,fecha,estadoDoc, idOwner){
    ...
    boton.onclick = function(){
        ...
        .then(function() {
            ...
            document.getElementById('estadoDoc').value = '';
            document.getElementById('idOwner').value = '';
        })
        .catch(function(error) {
